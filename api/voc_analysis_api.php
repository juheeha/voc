...
function extractReasonsFromVOC($content) {
    ...
    $patterns = [
        ...
        'marketing' => '마케팅|CRM|프로모션|이벤트|리텐션|전환율|고객관리|쿠폰|할인|재구매|고객등급',
...
function getDefaultFAQ() {
    return [
        ...
        [
            'question' => 'Q. 마케팅 기능은 어떤 것들이 있나요?',
            'answer' => 'CRM을 통한 고객 관리, 프로모션/이벤트 운영 도구를 제공하여 잘 팔릴 수 있는 환경을 만들어드립니다. 리텐션 강화와 전환율 향상에 최적화되어 있습니다.'
        ],
        [
            'question' => 'Q. 기술 지원은 어떻게 받을 수 있나요?',
...
function getImprovementSuggestions($db) {
    return [
        ...
        'improvements' => [
            ...
            [
                'title' => 'CRM 고객 세분화 및 자동화',
                'description' => '고객 구매 패턴을 분석하여 자동으로 등급을 부여하고, 세분화된 타겟에게 맞춤형 프로모션을 자동 발송하여 리텐션과 전환율을 극대화합니다.'
            ],
            [
                'title' => '개발자 포털 강화',
...
function getSalesMessages($db) {
    return [
        ...
        'messages' => [
            ...
            [
                'title' => 'CRM/프로모션 운영 메시지',
                'message' => '잘 팔릴 수 있는 환경을 만들어드립니다! CRM 고객 관리와 프로모션/이벤트 운영 도구로 리텐션을 강화하고 전환율을 높이세요. 고객 데이터 분석부터 맞춤형 마케팅까지, 매출 증대의 모든 것을 지원합니다.'
            ],
            [
                'title' => '기술 지원 메시지',
