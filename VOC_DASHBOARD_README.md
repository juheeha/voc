...
2. **요금/결제 시스템** - 결제, 요금, 비용, 할인, 요금제 등
3. **일반 영업상담** - 영업, 상담, 서비스안내, 계약 등
4. **마케팅 도구/광고** - 마케팅, 광고, SEO, 네이버쇼핑, 구글애즈 등
5. **기술지원/API 연동** - API, 연동, 개발, 기술지원, 시스템 등

#### 고객 질문 예시
각 신청사유 카드에는 고객들이 실제로 하는 질문 예시가 표시됩니다:
- **해외진출**: "해외 배송을 어떻게 해야 하나요?", "일본 시장 진출 시 PG 연동은 어떻게 되나요?" 등
- **요금/결제**: "월 이용료가 얼마인가요?", "장기 계약 시 할인 혜택이 있나요?" 등
- **일반 영업상담**: "카페24 프로 서비스가 뭔가요?", "무료 체험이 가능한가요?" 등
- **마케팅**: "네이버 쇼핑 연동은 어떻게 하나요?", "SEO 설정 도와주실 수 있나요?" 등
- **기술지원**: "API 문서를 받을 수 있나요?", "외부 시스템 연동이 가능한가요?" 등
...
2. **요금/결제**
   - 키워드: 결제, 요금, 비용, 가격, 할인, 무료, 청구, 요금제 등

3. **마케팅**
   - 키워드: 마케팅, 광고, SEO, 네이버쇼핑, 구글애즈, 검색엔진 등

4. **기술지원**
   - 키워드: API, 연동, 개발, 기술, 시스템, 오류, 보안 등
